...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "Bitcoin-Pizza-seeder\n"
...
static const string mainnet_seeds[] = {"47.97.179.225", "120.79.52.168", "47.94.215.249", "39.104.64.100", ""};
static const string testnet_seeds[] = {"47.97.179.225", "120.79.52.168", "47.94.215.249", "39.104.64.100", ""};

static const string *seeds = mainnet_seeds;

extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("47.97.179.225", 8866), true);
  }
  do {
